...
const Card = ({allcampaign, setOpenModel, setDonate , title}) => {
    ...
    const daysLeft = (deadline) => {
        ...
        const remaningDays = difference / (1000*3600*24);
        return remaningDays.toFixed(0);
    };

    return (
        <div class="px-4 pu-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
